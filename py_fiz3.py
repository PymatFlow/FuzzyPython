...
serv_level_lo = fuzz.interp_membership(x_serv, serv_lo, 8.8)
serv_level_md = fuzz.interp_membership(x_serv, serv_md, 8.8)
serv_level_hi = fuzz.interp_membership(x_serv, serv_hi, 8.8)
